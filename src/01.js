...
/***/ function(module, exports, __webpack_require__) {
  ...
  var router = new _vueRouter2.default({ //配置路由
      history: process.env.NODE_ENV !== 'production'
  });
  router.map(_route2.default);

  router.start(_vue2.default.extend({}), '#main');
  ...
  exports.default = {
      '/': {
          component: function component(resolve) {
              !/* require */(/* empty */function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(7)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.call(this));
          },
          subRoutes: {
              '/': {
                  auth: false,
